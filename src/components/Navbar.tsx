  ...
  return (
    <header className="w-full h-auto bg-white shadow-md px-6 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Sign In / Logout (All screen sizes) */}
        {status ? (
          <button
            onClick={logout}
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`fixed top-0 right-0 h-screen w-full bg-white z-[9999]
        ...
        <div className="px-6 space-y-6 text-gray-800 text-lg font-medium">
          ...
          {status ? (
            ...
            <div className="flex gap-4">
              <Link
                href="/login"
                className="w-[100px] text-center bg-gradient-to-r from-cyan-500 to-teal-400 text-white px-5 py-2 rounded-full text-sm font-semibold hover:opacity-90"
              >
                SIGN IN
              </Link>
              <Link
